...
const PERSONAL: { title: string, desc: string, tags: string[], link: string, imgs: string[], wip?: boolean }[] = [
  ...
  { title: 'Hello World - Goosebumps', desc: 'An atmospheric, immersive digital experience built to explore the boundaries of spooky, dynamic typography and creative web design aesthetics to deliver a highly thematic narrative.', tags: ['React', 'Tailwind'], link: 'https://hello-world-gamma-plum.vercel.app/', imgs: ['/images/Hello word - goosebumps.webp'] },
  { title: 'Birthday - Star Alert!', desc: 'A highly engaging and interactive celebratory greeting card that utilizes complex floating particle animations and precise custom CSS timeline effects to deliver a memorable, joyous user experience.', tags: ['React', 'Tailwind'], link: 'https://happy-b-day-murex.vercel.app/', imgs: ['/images/Birthday - Star Alert!.webp'] },
  { title: 'GroundSpot', desc: 'A modern, full-scale facility and space booking platform currently in active development. It features dynamic scheduling interfaces, real-time availability checks, and a clean visual hierarchy for streamlined end-user reservations.', tags: ['React', 'Tailwind'], link: 'https://ground-spot-frontend-web.vercel.app/', imgs: ['/images/GrooundSpot.png', '/images/Login-GroundSpot.png', '/images/GrooundSpot-dashboard.png'], wip: true },
]
