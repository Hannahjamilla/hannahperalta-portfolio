              ...
              <div className="col-span-4 flex flex-col items-start">
                ...
                >
                  <div className={`w-full h-full rounded-2xl overflow-hidden flex items-center justify-center relative ${t(dark, 'bg-[#0d0d18]', 'bg-gray-50')}`}>
                    ...
                    <img src="/images/Hannah-casual2.webp" alt="Hannah Peralta casual" className="absolute inset-0 w-full h-full object-cover opacity-0 transition-opacity duration-500 group-hover:opacity-100" loading="lazy" decoding="async" width="256" height="288" />
              ...
              {tab === 'awards' && (
                <div className="flex flex-col sm:grid sm:grid-cols-2 xl:grid-cols-2 gap-3 sm:gap-4">
                  {ACHIEVEMENTS.map((a, i) => (
                    <div key={i} onClick={() => setDetailModal({ title: a.title, date: a.date, desc: a.desc })} className={`w-full flex items-center gap-3 sm:gap-4 p-3 sm:p-5 rounded-2xl border transition-all cursor-pointer hover:scale-[1.01] active:scale-[0.98] ${card}`}>
